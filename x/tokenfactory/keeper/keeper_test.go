...
func (suite *KeeperTestSuite) SetupTest() {
	...
	fundAccsAmount := sdk.NewCoins(sdk.NewCoin(sdk.DefaultBondDenom, sdk.NewInt(100_000_000)), sdk.NewCoin(testhelpers.SecondaryDenom, testhelpers.SecondaryAmount))
